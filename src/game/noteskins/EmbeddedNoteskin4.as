package game.noteskins
{
    ...
    public class EmbeddedNoteskin4 implements IEmbeddedNoteskin
    {
        ...
        private static const NOTESKIN:Noteskin = new Noteskin(ID, "SM Orbular", Noteskin.TYPE_SWF, 0, 64, 64);
