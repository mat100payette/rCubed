package game.noteskins
{
    ...
    public class EmbeddedNoteskin7 implements IEmbeddedNoteskin
    {
        ...
        private static const NOTESKIN:Noteskin = new Noteskin(ID, "Delta (White)", Noteskin.TYPE_SWF, 90, 64, 64);
