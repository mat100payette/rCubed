package
{
    ...
    public class AirContext
    {
        ...
        static public function getSongCachePath(song:Song):String
        {
            ...
            return Constant.SONG_CACHE_PATH + (song.songInfo.engine ? MD5.hash(song.songInfo.engine.id) + "/" + MD5.hash(song.songInfo.levelId.toString()) : "57fea2a7e69445179686b7579d5118ef/" + MD5.hash(song.songInfo.level.toString())) + "/";
        }
